...
class QuesthouseCrawler(RoomsCrawler):
    START_INFO = [
        {
            "url": "https://www.questhouse.bg/rezerviray-chas",
            "shortcut": "https://docs.google.com/spreadsheets/d/165YWYhIfI6e1n_pv4uikid28HNpaZuyP6j7GIIJ9kMg/edit?gid=1870841199#gid=1870841199",
            "room": "QuestHouse-Лудосттанагения",
        }
    ]
        ...
        for day_index, day in enumerate(days):
            ...
            if day_index == 0:
                past_times = self.safe_find(
                    '[class="flex flex-col py-4 text-center font-semibold rounded transition-all duration-300 uppercase text-[#7CA1D5] bg-[#062F6A] cursor-not-allowed!"]',
                    attr="innerText",
                    multiple=True,
                )
